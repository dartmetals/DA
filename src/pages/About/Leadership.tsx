  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        marginBottom: '16px',
        boxShadow: hovered ? '0 8px 28px rgba(37,99,235,0.25)' : '0 4px 14px rgba(0,0,0,0.14)',
        border: hovered ? '2px solid #2563eb' : '2px solid transparent',
        transition: 'all 0.3s ease',
        position: 'relative', overflow: 'hidden',
      }}>
        {/* TMI banner in avatar */}
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '32px', backgroundColor: 'rgba(37,99,235,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {/* Info */}
      <h3 style={{
        fontSize: '14.5px', fontWeight: '700', color: '#2563eb',
      ...
      {hovered && (
        <div style={{
          ...
          width: '220px', backgroundColor: '#1e3a8a',
  ...
  <AboutLayout title="Leadership">
    ...
    <div style={{ backgroundColor: '#fff', padding: '55px 0 0' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px', textAlign: 'center' }}>
        ...
        <div style={{ width: '50px', height: '3px', backgroundColor: '#2563eb', margin: '0 auto 60px' }} />
      </div>
    ...
    {/* ── Advisory Board ── */}
    <div style={{ backgroundColor: '#f0f4ff', padding: '60px 0' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 40px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
          {[
            ...
            <div key={i} style={{
              backgroundColor: '#fff', border: '1px solid #e0e8ff',
              ...
              <span style={{
                ...
                color: '#2563eb', backgroundColor: '#e0e8ff', padding: '3px 10px',
